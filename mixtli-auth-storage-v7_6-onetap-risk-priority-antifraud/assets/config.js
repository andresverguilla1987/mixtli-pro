// assets/config.js
window.MIXTLI_CFG = {
  mode: 'demo', // 'demo' | 'supabase' | 'prisma'
  currency: 'MXN',
  country: 'MX',
  products: [
  ...
  cryptoRates: { BTC: 900000, ETH: 30000, USDC: 17 }, // precios aproximados en MXN
  endpoints: {
    demo: { auth:'/auth/register', billing:'/billing/checkout' },
    supabase: { url:'https://YOUR-SUPABASE', anon:'PUBLIC-ANON-KEY' },
    prisma: { apiBase:'' } // mismo host
  }
};
