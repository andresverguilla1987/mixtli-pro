...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type','x-mixtli-pin','x-mixtli-pass']
}));
...
// Sign GET for thumbnail (falls back to original if not found)
...
// Share links (create/revoke/fetch)
...
app.listen(PORT, ()=>{
  console.log('[Mixtli v6] ALLOWED_ORIGINS =', ALLOWED_ORIGINS);
  console.log('[Mixtli v6] ZIP_MAX_KEYS =', ZIP_MAX_KEYS);
