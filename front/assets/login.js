import {CFG} from './config.js';import * as API from './adapter.js';const $=q=>document.querySelector(q);$('#apiBase').value=CFG.API_BASE;
const L=$('#tabLogin'),R=$('#tabReg'),B1=$('#loginBox'),B2=$('#regBox');
